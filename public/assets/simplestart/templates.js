...
`
...

		{
			...
			<div class="is-section is-section-100 is-box is-light-text type-poppins">
				<div class="is-overlay">
					<div class="is-overlay-content" data-module="video-bg" data-module-desc="Video Background" data-dialog-width="600px" data-dialog-height="350px" data-html="${encodeURIComponent(`
						<video class="is-video-bg" poster="" playsinline="" autoplay="" muted="" loop="">
							<source src="[%IMAGE_PATH%]videos/market.mp4" type="video/mp4">
						</video>
